...
class ActivitiesViewModel: ViewModel() {
    ...
    fun fetchAllMySellings(){
        Log.e("SATTIKLARIM","giriyor musun")
        fetchAdvertApi.getAllMySellings().enqueue(object : Callback<AdvertSellings>{
            override fun onResponse(
                ...
                Log.e("SATTIKLARIM",data.toString())
                if (data != null)
                {
                    Log.e("SATTIKLARIM",data.success.toString())
                    Log.e("SattıklarımData",data.adverts.toString())
            ...
            override fun onFailure(call: Call<AdvertSellings>, t: Throwable) {
                Log.e("Activities",t.message.toString())
            }
        })
    }
    ...
    fun fetchAllMyPurchases(){
        fetchAdvertApi.getAllMyPurchases().enqueue(object : Callback<AdvertPurchases>{
            override fun onResponse(
                ...
                if (data != null)
                {
                    Log.e("ALDIKLARIM",data.success.toString())
                    Log.e("AldıklarımData",data.adverts.toString())
