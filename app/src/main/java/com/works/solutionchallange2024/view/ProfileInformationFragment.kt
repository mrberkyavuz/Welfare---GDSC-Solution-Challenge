...
class ProfileInformationFragment : Fragment(), permissionS {
    ...
    lateinit var mapView: MapView // Değişkeni null olarak tanımlayın
    ...
    override fun onCreateView(
        ...
        mapView = binding.root.findViewById(R.id.mapView) // Burada mapView'i tanımlayın
        ...
        //BURDAN İTİBAREN HARİTA İŞLEMLERİ
        binding.profileLocationTextView.setOnClickListener {
            // KULLANICI KONUM VERİLERİNİN VARLIĞI KONTROL EDEİLİR.
    ...
    // YORUM SATIRINDA OLAN TÜM FONKSİYONLAR GOOGLE HARİTALAR İÇİN
