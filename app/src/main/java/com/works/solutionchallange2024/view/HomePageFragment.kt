...
class HomePageFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        homepageViewModel.tagList.observe(viewLifecycleOwner) { tagList ->
            ...
            //listedeki elemanlar silinirse sadece bir kere çalıştırın!!
        ...
        searchText.addTextChangedListener(object : TextWatcher {
            ...
            override fun onTextChanged(s: CharSequence?, start: Int, before: Int, count: Int) {
                if (s.isNullOrBlank()) {
                    ...
                    search(s.toString()) // Her karakter değiştiğinde arama yap
    ...
    private fun loadTags() {
        val job = CoroutineScope(Dispatchers.Main).launch {
            ...
            for (tag in list) {
                ...
                //Log.e("okuma basarili", "${tag.tag_id},${tag.tag_name}")
            }
        }
    }
