        ...
        clientService.auth(userLogin).enqueue(object : Callback<UserLoginResponse> {
            override fun onResponse(call: Call<UserLoginResponse>, response: Response<UserLoginResponse>) {
                ...
                if (data?.success == true) {
                    ...
                    // Oturum açma başarısızsa gerekli işlemleri yap
                    Log.e("HomeActivity", "Oturum açma başarısız: ${data?.success}")
                }
            }

            override fun onFailure(call: Call<UserLoginResponse>, t: Throwable) {
                // İstek hatası durumunda gerekli işlemleri yap
                Log.e("HomeActivity", "Oturum açma isteği başarısız", t)
            }
        })
    }
